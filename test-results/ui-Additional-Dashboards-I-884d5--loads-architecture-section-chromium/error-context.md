...
- Name: ui.spec.ts >> Additional Dashboards >> IT dashboard loads architecture section
- Location: tests/ui.spec.ts:302:3
...
Expected pattern: /ระบบคัดกรองความปลอดภัย 7 ชั้น|Security Layer|Bedrock|Audit|AI Control Tower/
Received string:  "
    กำลังโหลดหน้าระบบ...····
"
```
