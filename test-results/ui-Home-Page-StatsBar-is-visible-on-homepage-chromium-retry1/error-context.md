...
- Name: ui.spec.ts >> Home Page (/) >> StatsBar is visible on homepage
- Location: tests/ui.spec.ts:47:3
...
Expected pattern: /160,000\+|OpenLaw Thailand Dataset|PDPA 100%/
Received string:  "
    BetaLegalGuard AIเทคโนโลยี AI เพื่อความยุติธรรมและการกำกับดูแลระดับชาติหน้าแรกสืบค้นกฎหมายสาระความรู้ศูนย์รวม DashboardTrust & Privacyแสดงผลอย่างรับผิดชอบและตรวจสอบย้อนหลังได้โครงสร้างพื้นฐานกฎหมายอัจฉริยะระดับชาติSmart LegalGuard AIการพัฒนาโครงสร้างพื้นฐานด้านข้อมูลกฎหมายด้วยเทคโนโลยี AI ที่ผ่านการตรวจสอบได้ เพื่อสนับสนุนความโปร่งใสในกระบวนการยุติธรรมและอำนวยความสะดวกแก่ประชาชนสืบค้นกฎหมายดูระบบเจ้าหน้าที่ ออกแบบสำหรับ deployment ในไทย audit-ready และ privacy-aware พัฒนาตามแนวทาง Responsible AI—เป้าหมายฐานข้อมูลคำพิพากษารอข้อมูลเป้าหมายจาก backend—PDF ที่มีในระบบตอนนี้actual count จาก backend system stats—ชุดข้อมูล Hugging Faceactual count จาก backend system stats—Audit entries ที่บันทึกแล้วรอ backend system statsOfficial Responsible AI PartnersCOJศาลยุติธรรมTIJTIJ THAILANDAWSAWS PartnerETDAสพธอ. (ETDA)AIGCAI GovernanceCOJศาลยุติธรรมTIJTIJ THAILANDAWSAWS PartnerETDAสพธอ. (ETDA)AIGCAI Governance เลือกพื้นที่ปฏิบัติงานของคุณระบบตอบสนองตาม บทบาทของผู้ใช้งานLegalGuard AI ปรับสถาปัตยกรรมและ Guardrails อัตโนมัติ เพื่อให้สอดคล้องกับจริยธรรมของแต่ละกลุ่มภารกิจงานยุติธรรมภาคประชาชนประชาชนทั่วไป / ผู้เสียหายค้นหาข้อมูลกฎหมายและขั้นตอนการดำเนินคดีด้วยภาษาชาวบ้านที่เข้าใจง่ายค้นหาด้วยภาษาธรรมชาติระบบช่วยร่างคำฟ้องบอทช่วยทางกฎหมายเข้าสู่พื้นที่ปฏิบัติงานภาคธุรการศาลเจ้าหน้าที่ศาล / ข้าราชการธุรการระบบสนับสนุนงานธุรการศาล จัดการสำนวนคดี รับคำฟ้อง คัดกรองเอกสาร และติดตามสถานะคดีคัดกรองคำฟ้องด้วย AIจัดการสำนวนและติดตามคดีนำเข้าข้อมูลและตรวจสอบ Auditเข้าสู่พื้นที่ปฏิบัติงานระบบตุลาการผู้พิพากษา / ตุลาการศาลปกครองเครื่องมือสนับสนุนการพิจารณาคดี ช่วยสืบค้นแนวคำพิพากษา วิเคราะห์ประเด็น และยกร่างคำพิพากษาเบื้องต้นสืบค้นแนวฎีกาและคำวินิจฉัยช่วยยกร่างคำพิพากษาตรวจสอบความเป็นธรรม (Fairness)เข้าสู่พื้นที่ปฏิบัติงานระบบ IT / แอดมินฝ่ายไอที / ผู้ดูแลระบบศูนย์ควบคุม monitoring, audit, benchmark, release readiness และ governance สำหรับ rollout ระบบ AI ในศาลมองเห็น metrics และ incidentตรวจ audit + PII + release guardคุม ingestion และ benchmarkเข้าสู่พื้นที่ปฏิบัติงาน ความเป็นส่วนตัวตามบทบาท ปกป้องตัวตนด้วย privacy-by-design ความปลอดภัยระดับโครงสร้างพื้นฐาน System Trust Layerผู้ใช้งานทุกบทบาทอยู่ภายใต้โครงสร้างความปลอดภัยเดียวกันตั้งแต่ประชาชนจนถึงผู้พิพากษา ทุกคำขอจะผ่าน privacy, routing, retrieval, guardrails, multi-agent review และ audit chain ก่อนแสดงผล เพื่อให้ระบบตรวจสอบย้อนหลังและคุมความเสี่ยงได้จริงระบบคัดกรองความปลอดภัย 7 ชั้น (7-Layer Safety Pipeline) · โหมดสำรองสำหรับเดโม เมื่อ backend ไม่พร้อมตอบ runtime evidenceแหล่งข้อมูล: กำลังตรวจ runtime Fallback View Runtime Not VerifiedL2ไม่มีข้อมูลPII Sanitizationปกปิดข้อมูลส่วนบุคคลL0ไม่มีข้อมูลIntent Routingวิเคราะห์เส้นทางการทำงานL1ไม่มีข้อมูลHybrid Retrievalค้นข้อมูลกฎหมายหลายชั้นL4ไม่มีข้อมูลContext Filterคัดเฉพาะบริบทที่เกี่ยวข้องL5ไม่มีข้อมูลAI Guardrailsคุม governance และ complianceL6ไม่มีข้อมูลHallucination Auditตรวจทาน reasoning หลาย agentauditไม่มีข้อมูลCrypto Logบันทึก hash chain ย้อนหลังได้ดู Trace Console ดู AI Control Tower KPI Blueprintผลลัพธ์ที่ระบบควรถูกวัดจริงKPI ด้านล่างออกแบบให้เชื่อมตรงกับ pain point ของศาลและประชาชน เพื่อใช้เป็น baseline สำหรับ pilot, rollout และการประเมินผลเชิงนโยบายมิติการวัดผลความเร็ว · ความแม่นยำ · ความเป็นธรรม · การเข้าถึง · ความเชื่อมั่น30-50%ลดเวลายกร่าง/ตรวจร่างจาก drafting assistant และ review automation10-25%ลดคดีค้างสะสมจาก bottleneck analytics และ allocation>= 85%Top-5 Recallสำหรับการค้นคืนคำพิพากษาที่เกี่ยวข้อง>= 95%Citation Accuracyอ้างอิงมาตราและคำพิพากษาได้แม่นยำ0 leakagePII Exposureผลลัพธ์ต้องไม่รั่วข้อมูลส่วนบุคคล< 1 dayเข้าถึงบริการประชาชนลดระยะเวลาจากวันหรือสัปดาห์ให้ทันทีขึ้น พัฒนาภายใต้แนวทางความรับผิดชอบด้าน AIสถาปัตยกรรม ระดับรัฐเอกภาพเทคโนโลยีที่ออกแบบให้ตรวจสอบย้อนหลังได้ เพื่อลดความเสี่ยงและยกระดับความโปร่งใสของกระบวนการยุติธรรมระบบสนับสนุนภาคประชาชนเครื่องมือช่วยสืบค้นข้อกฎหมายและระเบียบที่เกี่ยวข้อง พร้อมคำอธิบายเบื้องต้นเพื่อความเข้าใจที่ถูกต้อง (Citizen Support Features)ระบบสนับสนุนงานบริหารจัดการสนับสนุนการบริหารจัดการเอกสารและคัดกรองข้อมูลเบื้องต้น เพื่อเพิ่มประสิทธิภาพการทำงานของเจ้าหน้าที่ (Administrative Support Stack)ระบบสนับสนุนงานตุลาการเครื่องมือรวบรวมข้อกฎหมายและแนวทางคำพิพากษา เพื่อประกอบการพิจารณาและตรวจสอบความถูกต้องเชิงกฎหมาย (Judicial Support Stack)ค้นหาด้วยภาษาธรรมชาติอ้างอิงมาตราและเลขฎีกาจริงปกป้องข้อมูลตาม PDPAข้อมูลเก็บในประเทศไทยระบบป้องกัน AI หลอนSmart LegalGuard AIETDA Responsible AI Innovation Hackathon 2026 — AI for Justiceต้นแบบระบบสืบค้นข้อมูลกฎหมายไทยและ workflow ด้านความยุติธรรม ที่ออกแบบให้ตรวจสอบย้อนหลังได้และใช้งานอย่างรับผิดชอบPrivacy-aware · audit-ready · demo-safe บริการหลัก» สืบค้นกฎหมายภาคประชาชน» ศูนย์รวมความน่าเชื่อถือของระบบ» ศูนย์รวมระบบหลังบ้าน» Clerk Copilot สำหรับธุรการศาล» Judge Workbench สำหรับตุลาการ» AI Control Tower สำหรับฝ่าย IT» โซลูชันสำหรับนักกฎหมาย (Private Offering) ลิงก์หน่วยงานศาลยุติธรรม ศาลปกครอง ราชกิจจานุเบกษา ETDA (สพธอ.)  ช่องทางการติดต่อหน้านี้เป็นต้นแบบสำหรับการสาธิตผลิตภัณฑ์หากต้องการข้อมูลบริการศาลหรือการติดต่อจริง โปรดใช้ลิงก์หน่วยงานทางการในคอลัมน์ด้านซ้าย© 2569 Smart LegalGuard AI — ศูนย์รวมนวัตกรรม AI เพื่อความยุติธรรมDesigned & Developed byHonest PredictorETDA Responsible AI Innovation Hackathon 2026 | governance-first prototype สำหรับการสาธิตและประเมินเชิงสถาบันสวัสดีครับ! 🙏มีคำถามกฎหมายไหม? กดคุยได้เลยน้องซื่อสัตย์ AI····
"
```
...
> 51  |     expect(body).toMatch(/160,000\+|OpenLaw Thailand Dataset|PDPA 100%/);
  ...
  139 |     await goto(page, "/judgment/nonexistent-id-xyz");
  140 |     const body = await page.textContent("body");
  141 |     expect(body).toMatch(/ไม่พบ|not found|404/i);
  142 |   });
  143 | 
  144 |   test("has back navigation", async ({ page }) => {
  145 |     await goto(page, "/judgment/jdg-001");
  146 |     const backBtn = page.locator("a[href='/search'], button:has-text('กลับ'), a:has-text('กลับ')");
  147 |     // Either has a back link or breadcrumb
  148 |     const hasBack = await backBtn.count();
  149 |     expect(hasBack).toBeGreaterThanOrEqual(0); // page must render without error
  150 |   });
  151 | });
```